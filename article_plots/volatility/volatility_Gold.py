...
data = yf.download("GC=F", start="2000-01-01", end="2024-05-31")
print(data)
...
gp_params={
    ...
    "title": "",
    "fname": "volatility_Gold",
    "dirname": "plots",
    "markers": None,#[None,".",".",".",".",".","."],
    "legend": {
        "location": "top_left",
        "labels": ["Gold Log-Volatility","R/S Hurst","variogram Hurst","Higuchi Hurst","Whittle Hurst","1D CNN Hurst","LSTM Hurst"]
    },
    "baselines":{
        "labels": [],
        "values": [0.5],
