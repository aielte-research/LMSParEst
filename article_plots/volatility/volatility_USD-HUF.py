...
data = yf.download("HUF=X", start="1990-01-01", end="2024-05-31")
print(data)
...
gp_params={
    ...
    "title": "",
    "fname": "volatility_USD-HUF",
    "dirname": "plots",
    "markers": None,#[None,".",".",".",".",".","."],
    "legend": {
        "location": "top_left",
        "labels": ["USD-HUF Log-Volatility","R/S Hurst","variogram Hurst","Higuchi Hurst","Whittle Hurst","1D CNN Hurst","LSTM Hurst"]
    },
    "baselines":{
        "labels": [],
        "values": [0.5],
