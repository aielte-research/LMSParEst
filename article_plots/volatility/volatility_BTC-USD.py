...
data = yf.download("BTC-USD", start="1990-01-01", end="2024-05-31")
print(data)
...
gp_params={
    ...
    "title": "",
    "fname": "volatility_BTC-USD",
    "dirname": "plots",
    "markers": None,#[None,".",".",".",".",".","."],
    "legend": {
        "location": "top_right",
        "labels": ["BTC-USD Log-Volatility","R/S Hurst","variogram Hurst","Higuchi Hurst","Whittle Hurst","1D CNN Hurst","LSTM Hurst"]
    },
    "baselines":{
        "labels": [],
        "values": [0.5],
