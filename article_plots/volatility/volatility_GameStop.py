...
data = yf.download("GME", start="2014-01-01", end="2024-05-31")
print(data)
...
gp_params={
    ...
    "title": "",
    "fname": "volatility_GameStop",
    "dirname": "plots",
    "markers": None,#[None,".",".",".",".",".","."],
    "legend": {
        "location": "bottom_left",
        "labels": ["GameStop Log-Volatility","R/S Hurst","variogram Hurst","Higuchi Hurst","Whittle Hurst","1D CNN Hurst","LSTM Hurst"]
    },
    "baselines":{
        "labels": [],
        "values": [0.5],
