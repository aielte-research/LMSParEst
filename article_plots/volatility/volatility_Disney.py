...
data = yf.download("DIS", start="1950-01-01", end="2024-05-31")
print(data)
...
gp_params={
    ...
    "title": "",
    "fname": "volatility_Disney",
    "dirname": "plots",
    "markers": None,#[None,".",".",".",".",".","."],
    "legend": {
        "location": "top_left",
        "labels": ["Disney Log-Volatility","R/S Hurst","variogram Hurst","Higuchi Hurst","Whittle Hurst","1D CNN Hurst","LSTM Hurst"]
    },
    "baselines":{
        "labels": [],
        "values": [0.5],
