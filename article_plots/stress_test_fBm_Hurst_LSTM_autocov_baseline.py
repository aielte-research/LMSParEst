...
autocov=Autocov({'diff':diff, "num_cores": num_cores},None)
...
est_autocov += [float(val) for val in autocov(input.cpu())]
...
scatter_Ys_autocov = est_autocov.copy()
...
Ys_autocov.append(np.square(np.asarray(orig) - np.asarray(est_autocov)).mean())

# general_plot({
#     "Ys": [Ys_r_over_s,Ys_variogram,Ys_higuchi,Ys_whittle,Ys_autocov,Ys],
#     "Xs": Xs,
#     "xlabel": "Window size",
#     #"xscale": "log",
#     "ylabel": "MSE loss",
#     #"yscale": "log",
#     "title": "",
#     "fname": "stress_test_fBm_Hurst_LSTM_autocov_baseline",
#     "dirname": "./plots",
#     "legend": {
#         "location": "top_left",
#         "labels": ["R/S","variogram","Higuchi","Whittle","Autocov","LSTM"]
#     },
#     "markers": None,
#     "colors":  ["red","red","red","red","green"]+[Category10[10][0]],
...
print(len(scatter_Xs))
print(len(scatter_Ys_r_over_s))

scatter_plot({
    "Xs": [scatter_Xs[:2000]]*6,
    "Ys": [scatter_Ys_r_over_s[:2000], scatter_Ys_variogram[:2000], scatter_Ys_higuchi[:2000], scatter_Ys_whittle[:2000], scatter_Ys_autocov[:2000], scatter_Ys_lstm[:2000]],
    "xlabel": "Hurst",
    "ylabel": "Inferred value",
    "title": "",
    "fname": "stress_test_scatter_fBm_Hurst_LSTM_autocov_baseline",
    "dirname": "./plots",
    "circle_size": 4,
    "x_jitter": 0,
    "opacity": 0,
    "heatmap": False,
    "colors": [Category10[10][1],Category10[10][2],Category10[10][3],Category10[10][4],Category10[10][5],Category10[10][0]],
    "line45_color": "black",
    "legend": {
