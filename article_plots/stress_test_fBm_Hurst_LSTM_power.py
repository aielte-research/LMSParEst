...
for n in tqdm(ns):
    ...
    for _ in tqdm(range(5)):
        ...
        for __ in range(100):
            ...
            process = [x**H for x in np.linspace(0.0, 1.0, num=n)]
    ...
    scatter_plot({
        ...
        "title": "",
        "fname": f"stress_test_scatter_fBm_Hurst_LSTM_power_{n}",
        "dirname": "./power",
        "circle_size": 5,
        "x_jitter": 0,
        "opacity": 0,
...
params={
    ...
    "ylabel": "Inferred Value",
    "title": "",
    "fname": f"stress_test_scatter_fBm_Hurst_LSTM_power_LSTM",
    "dirname": "./power",
    "circle_size": 5,
    "x_jitter": 0,
    "opacity": 0,
...
params["fname"] = f"stress_test_scatter_fBm_Hurst_LSTM_power_r_over_s"
scatter_plot(params)

params["Ys"] = Ys_variogram
params["fname"] = f"stress_test_scatter_fBm_Hurst_LSTM_power_variogram"
scatter_plot(params)

params["Ys"] = Ys_higuchi
params["fname"] = f"stress_test_scatter_fBm_Hurst_LSTM_power_higuchi"
scatter_plot(params)

params["Ys"] = Ys_whittle
params["fname"] = f"stress_test_scatter_fBm_Hurst_LSTM_power_whittle"
scatter_plot(params)