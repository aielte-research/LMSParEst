...
class Heston:
    ...
    def __init__(self, n=1000,
                 ...
                 const_correlation=False, rough_correlation=False, fractional_wieners=False, hybrid_wieners=False, rough_volatility=True,
    ...
    def correlated_fractional_wieners(self):
        s = fbm(hurst=self.hurst1, n=self.n, length=self.T)
        ds = np.diff(s)
        w1 = fbm(hurst=self.hurst2, n=self.n, length=self.T)
        dw1 = np.diff(w1)
        dw2 = self.dw2
        w2 = self.w2
...
def gen(n=1000, S0=0.05, v0=0.03, kappa=0.07, alpha=0.06, mu1=0.01, mu2=0.5,
        sigma=0.05, theta=0.05, eta=0.03, T=1, dt=0.001, rho=-0.3,
        fou_hurst=0.02, hurst1=0.7, hurst2=0.7,
        const_correlation=False, rough_correlation=False, fractional_wieners=False,
        hybrid_wieners=False, rough_volatility=True, discretization='euler'):
